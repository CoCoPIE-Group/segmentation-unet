...
parser.add_argument('--percent', default=0.5, type=float, dest='percent')
parser.add_argument('--alpha', default=25.0, type=float, dest='alpha')
parser.add_argument('--pretrained-model', default='', type=str, dest='pretrained model')

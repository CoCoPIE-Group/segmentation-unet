...
class UNet(nn.Module):
    def __init__(self, nch_in, nch_out, nch_ker=64, norm='bnorm'):
        ...
        Decoder part
        """
        self.dec5_1 = CNR2d(16 * self.nch_ker, 16 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        ...
        self.dec4_2 = CNR2d(2 * 8 * self.nch_ker, 8 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec4_1 = CNR2d(8 * self.nch_ker,     8 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        ...
        self.dec3_2 = CNR2d(2 * 4 * self.nch_ker, 4 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec3_1 = CNR2d(4 * self.nch_ker,     4 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        ...
        self.dec2_2 = CNR2d(2 * 2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec2_1 = CNR2d(2 * self.nch_ker,     2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
...
class UNet_small_dense1(nn.Module):
    def __init__(self, nch_in, nch_out, nch_ker=64, norm='bnorm'):
        super(UNet_small_dense1, self).__init__()
        ...
        self.enc4_1 = CNR2d(4 * self.nch_ker, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        ...
        Decoder part
        """
        self.dec5_1 = CNR2d(1 * self.nch_ker, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool4 = UnPooling2d(pool=2, type='nearest')
        # self.unpool4 = UnPooling2d(pool=2, type='bilinear')
        self.unpool4 = UnPooling2d(nch=1 * self.nch_ker // 2, pool=2, type='conv')

        self.dec4_2 = CNR2d(1 * self.nch_ker + 1 * self.nch_ker // 2, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec4_1 = CNR2d(1 * self.nch_ker, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool3 = UnPooling2d(pool=2, type='nearest')
        # self.unpool3 = UnPooling2d(pool=2, type='bilinear')
        self.unpool3 = UnPooling2d(nch=1 * self.nch_ker // 2, pool=2, type='conv')

        self.dec3_2 = CNR2d(4 * self.nch_ker + 1 * self.nch_ker // 2, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec3_1 = CNR2d(1 * self.nch_ker, 1 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool2 = UnPooling2d(pool=2, type='nearest')
        # self.unpool2 = UnPooling2d(pool=2, type='bilinear')
        self.unpool2 = UnPooling2d(nch=1 * self.nch_ker // 2, pool=2, type='conv')

        self.dec2_2 = CNR2d(2 * self.nch_ker + 1 * self.nch_ker // 2, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec2_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
...
class UNet_small_dense2(nn.Module):
    def __init__(self, nch_in, nch_out, nch_ker=64, norm='bnorm'):
        super(UNet_small_dense2, self).__init__()
        ...
        self.enc4_1 = CNR2d(4 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.enc4_2 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        self.pool4 = Pooling2d(pool=2, type='max')

        self.enc5_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        """
        Decoder part
        """
        self.dec5_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool4 = UnPooling2d(pool=2, type='nearest')
        # self.unpool4 = UnPooling2d(pool=2, type='bilinear')
        self.unpool4 = UnPooling2d(nch=1 * self.nch_ker, pool=2, type='conv')

        self.dec4_2 = CNR2d(2 * self.nch_ker + 1 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec4_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool3 = UnPooling2d(pool=2, type='nearest')
        # self.unpool3 = UnPooling2d(pool=2, type='bilinear')
        self.unpool3 = UnPooling2d(nch=1 * self.nch_ker, pool=2, type='conv')

        self.dec3_2 = CNR2d(4 * self.nch_ker + 1 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec3_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)

        # self.unpool2 = UnPooling2d(pool=2, type='nearest')
        # self.unpool2 = UnPooling2d(pool=2, type='bilinear')
        self.unpool2 = UnPooling2d(nch=1 * self.nch_ker, pool=2, type='conv')

        self.dec2_2 = CNR2d(2 * self.nch_ker + 1 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
        self.dec2_1 = CNR2d(2 * self.nch_ker, 2 * self.nch_ker, kernel_size=3, stride=1, norm=self.norm, relu=0.0)
